...
<html>
    ...
    <head>
        ...
        <script>
            ...
            xmlhttp.open("GET","filters.php?n="+strName);
            xmlhttp.send();
                }
            }
            ...
            xmlhttp.open("GET","filters.php?c="+strCategory);
            xmlhttp.send();
                }
            }
            ...
            xmlhttp.open("GET","filters.php?p="+strPrice);
            xmlhttp.send();
                }
            }
            ...
            <div class="allProducts">
                <div class="filtering">
                    <form class="filteringForm" target="_SELF">
                        ...
                        <button onclick=""><img src="../images/icons/icons8_Search.ico"></button>
